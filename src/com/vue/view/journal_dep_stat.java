...
import com.modele_table.pack.ModelTable_bilan_dep;
 ...
 * @author tchatseu
 */
public class journal_dep_stat extends javax.swing.JPanel {

    /**
     * Creates new form vue_produit
     */
 //ma liste de commande
	List<bilan_depense> lc=new ArrayList<bilan_depense>();
        bilan_depense jv=new bilan_depense();
	//mes variables
    ...
    private void rechercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rechercherActionPerformed
        ...
        try {
            ...
            Logger.getLogger(journal_dep_stat.class.getName()).log(Level.SEVERE, null, ex);
        }
